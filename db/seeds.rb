...
p "Making devs"
Developer.create!(name: "Marissa Orea", email: "marissa@gmail.com", title: "Full Stack Developer", description: "I am a Full Stack developer with a background in System Administration - I love building meaningful apps and features!", location: "NYC", password: "google")
Developer.create!(name: "Yan Wang", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I have a background in Marketing and Communications prior to Software Engineering. I also love photography!", location: "NYC", password: "google")
Developer.create!(name: "Justin Wang", email: "jwang@aol.com", title: "Full Stack Developer", description: "I have an aol email address for spam emails. I prefer Backend code over Frontend #codeallthethings.", location: "NYC", password: "google")
Developer.create!(name: "Maddie Tabing", email: Faker::Internet.unique.email, title: "Sr.Full Stack Developer", description: "I have a background in Public Relations prior to being a Software Engineer.", location: "Los Angeles", password: "google")
Developer.create!(name: "Forrest Benton", email: "fbenton@aol.com", title: "Full Stack Developer", description: "I have a background in law and love what I do now, which is code all the things and being a kick ass developer.", location: "NYC", password: "google")
Developer.create!(name: "Kritina Tong", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I have an IT background prior to being a Software Engineer. I am committed to building meaningful software!", location: "Los Angeles", password: "google")
Developer.create!(name: "Arielle Ramirez", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I am a Full Stack engineer, committed to code beautiful applications for my clients.", location: "Chicago", password: "google")
Developer.create!(name: "Olivia Tian", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I have a background in Accounting prior to being a Rails Engineer.", location: "Chicago", password: "google")
Developer.create!(name: "Jun Jian Shen", email: Faker::Internet.unique.email, title: "Sr.Full Stack Developer", description: "I love coding, it's my passion, but most of all I love building meaningful apps and features.", location: "NYC", password: "google")
Developer.create!(name: "Brian Wadlow", email: Faker::Internet.unique.email, title: "Sr. Full Stack Developer", description: "I am a Full Stack Engineer with a background in Media.", location: "Chicago", password: "google")
Developer.create!(name: "Yichen Jin", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I am a Full Stack Engineer with specializing in Rails and more! (coming soon)", location: "Chicago", password: "google")
Developer.create!(name: "Andrew Linder", email: "alinder@aol.com", title: "Full Stack Developer", description: "I worked as a trader at an investment bank for 3 years. I am now a Rails Engineer.", location: "Miami", password: "google")
...
Developer.create!(name: "Garry Clerge", email: Faker::Internet.unique.email, title: "Scary Garry", description: "People know me by Gearr Bear (or do they?), I teach budding Engineers! I also build beautiful apps.", location: "Miami", password: "google")
Developer.create!(name: "Jesse McReady", email: "jesse@aol.com", title: "Full Stack Developer", description: "I have a computer science degree and am now a Software Engineer. I love challenges, the quality of my works speaks for itself.", location: "NYC", password: "google")
Developer.create!(name: "Johnny Soong", email: "johnny.soong@splat.com", title: "Splat Code Expert", description: "I am an Engineer and a huge believer in using Splat(*) in Ruby code, you just never know how many arguments in methods you'll need, better to be safe than sorry. Rspec The Wealth is my motto.", location: "NYC", password: "google")
Developer.create!(name: "Jon Mines", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I am an instructor for budding Engineers. Additionally, I build beautiful interactive web applications.", location: "Miami", password: "google")
Developer.create!(name: "Lila Wang", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I am a Full Stack Engineer with the patience of a Goddess, Lila is my name and Rails Engineer is my game.", location: "NYC", password: "google")
Developer.create!(name: "Michael Coleman", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I am a Full Stack Engineer with a background in Finance for a startup company called Betterment", location: "Brooklyn", password: "google")
Developer.create!(name: "Parker Dinsmore", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "Prior to being a Full Stack Engineer, Prior to starting a new career path in coding I worked as an auditor.", location: "LA", password: "google")
Developer.create!(name: "Richard Chen", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I am a Full Stack Engineer, prior to coding, I've managed in retail for many years. I love building efficient web applications.", location: "NYC", password: "google")
Developer.create!(name: "Andrew Cohn", email: Faker::Internet.unique.email, title: "Full Stack Developer", description: "I have a Film background prior to Software Engineering.", location: "NYC", password: "google")
p "Done with devs"
